 ...
 *
 */
public class BookAuthorSingleSelectPanel extends Panel {
	private static final long serialVersionUID = 1L;
	
	public BookAuthorSingleSelectPanel(String id, Book book){
		super(id);
	...
	private void buildPanel(final Book book){
		...
		//１つ選択式質問
		RadioGroup<Author> singleChoiceRadioGroup = new RadioGroup<Author>("singleChoiceRadioGroup", new PropertyModel<Author>(book, "author"));
