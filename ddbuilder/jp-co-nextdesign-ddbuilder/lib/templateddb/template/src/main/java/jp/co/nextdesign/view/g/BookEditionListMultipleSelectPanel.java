 ...
 *
 */
public class BookEditionListMultipleSelectPanel extends Panel {
	private static final long serialVersionUID = 1L;
	
	public BookEditionListMultipleSelectPanel(String id, Book book){
		super(id);
	...
	private void buildPanel(final Book book){
		...
		//複数選択式
		CheckGroup<Edition> multipleChoiceCheckGroup = new CheckGroup<Edition>("multipleChoiceCheckGroup", book.getEditionList());
