...
import jp.co.nextdesign.ddb.core.template.cases.BdCodeCaseJavaEditPageOkManyToMany;
import jp.co.nextdesign.ddb.core.user.BdUserAttribute;
import jp.co.nextdesign.util.logging.NdLogger;

public class BdCodeBlockJavaEditPageOk extends BdCodeBlockBaseField {

	/** コンストラクタ */
	public BdCodeBlockJavaEditPageOk(List<BdCodeLine> lineList){
		super(lineList);
	}
	...
	protected BdBaseCodeCase createCodeCase(String key, List<BdCodeLine> lineListOfCase){
		...
		if (BdUserAttribute.KEY_ManyToMany.equals(key)){
			result = new BdCodeCaseJavaEditPageOkManyToMany(lineListOfCase);
