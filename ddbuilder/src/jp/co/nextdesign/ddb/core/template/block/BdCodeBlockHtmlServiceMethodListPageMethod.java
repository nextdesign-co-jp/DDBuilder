...
import jp.co.nextdesign.ddb.core.template.cases.BdCodeCaseHtmlServiceMethodListPageMethodAll;
import jp.co.nextdesign.util.logging.NdLogger;

public class BdCodeBlockHtmlServiceMethodListPageMethod extends BdCodeBlockBaseServiceMethodListPageMethod {

	/** コンストラクタ */
	public BdCodeBlockHtmlServiceMethodListPageMethod(List<BdCodeLine> lineList){
		super(lineList);
	}
	...
	protected BdBaseCodeCase createCodeCase(String key, List<BdCodeLine> lineListOfCase){
		...
		if (BdBaseCodeCase.KEY_All.equals(key)){
			result = new BdCodeCaseHtmlServiceMethodListPageMethodAll(lineListOfCase);
		} else {
