...
public class BdCodeCaseHtmlFieldEmbedded extends BdBaseCodeCase {

	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseHtmlFieldEmbedded(List<BdCodeLine> lineListOfCase){
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserAttribute a){
		...
		resultList.add(new BdStringHelperReplacementPattern("ISBN", a.getJavadocTitle()));
		return resultList;
	}
}
