...
public class BdCodeCaseJavaServiceResultPageDeclareListAll extends BdBaseCodeCase {

	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseJavaServiceResultPageDeclareListAll(List<BdCodeLine> lineListOfCase){
