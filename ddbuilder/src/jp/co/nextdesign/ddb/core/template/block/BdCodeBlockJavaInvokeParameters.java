...
import jp.co.nextdesign.ddb.core.template.cases.BdCodeCaseJavaInvokeParametersAll;
 ...
 *
 */
public class BdCodeBlockJavaInvokeParameters extends BdBaseCodeBlock {

	/** コンストラクタ */
	public BdCodeBlockJavaInvokeParameters(List<BdCodeLine> lineList){
		super(lineList);
	}
	...
	protected BdBaseCodeCase createCodeCase(String key, List<BdCodeLine> lineListOfCase){
		...
		if (KEY_InvokeAll.equals(key)){
			result = new BdCodeCaseJavaInvokeParametersAll(lineListOfCase);
