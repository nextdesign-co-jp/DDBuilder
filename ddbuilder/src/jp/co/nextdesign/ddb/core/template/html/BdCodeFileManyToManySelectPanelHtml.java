...
public class BdCodeFileManyToManySelectPanelHtml extends BdBaseCodeFile {
	 ...
	 */
	public BdCodeFileManyToManySelectPanelHtml(File file, BdTemplateProject project) throws BdBuilderException, BdApplicationPropertyException{
		super(file, project);
	}
	 ...
	 * @return
	 */
	private List<String> generateLines(BdUserClass c, BdUserAttribute a, List<BdStringHelperReplacementPattern> replacementPatternList) {
