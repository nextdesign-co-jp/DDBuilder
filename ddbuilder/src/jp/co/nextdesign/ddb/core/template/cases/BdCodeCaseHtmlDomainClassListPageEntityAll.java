...
public class BdCodeCaseHtmlDomainClassListPageEntityAll extends BdBaseCodeCase {
	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseHtmlDomainClassListPageEntityAll(List<BdCodeLine> lineListOfCase){
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserClass c){
		...
		resultList.add(new BdStringHelperReplacementPattern("書籍", c.getJavadocTitle()));
		return resultList;
	}
}
