...
import jp.co.nextdesign.ddb.core.template.block.BdCodeBlockNoCode;
import jp.co.nextdesign.util.logging.NdLogger;

public class BdCodeFileTestDataServiceJava extends BdBaseCodeFile {
	 ...
	 */
	public BdCodeFileTestDataServiceJava(File file, BdTemplateProject project) throws BdBuilderException, BdApplicationPropertyException{
		super(file, project);
	}
	...
	public List<BdGeneratedFile> generate(String groupId){
		...
		result.setOverwriteIfExists(false);
	...
	private static final String BLOCK_KEY_NoCode = "NoCode";
	...
	protected BdBaseCodeBlock createCodeBlock(String key, List<BdCodeLine> lineListOfBlock){
		...
		if (BLOCK_KEY_NoCode.equals(key)){
			result = new BdCodeBlockNoCode(lineListOfBlock);
		} else {
