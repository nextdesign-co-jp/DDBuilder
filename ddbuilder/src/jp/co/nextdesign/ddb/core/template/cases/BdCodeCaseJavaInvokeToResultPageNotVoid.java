...
public class BdCodeCaseJavaInvokeToResultPageNotVoid extends BdBaseCodeCase {

	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseJavaInvokeToResultPageNotVoid(List<BdCodeLine> lineListOfCase){
