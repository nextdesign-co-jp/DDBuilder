...
public class BdCodeCaseHtmlFieldString extends BdBaseCodeCase {

	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseHtmlFieldString(List<BdCodeLine> lineListOfCase){
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserAttribute a){
		...
		resultList.add(new BdStringHelperReplacementPattern("name", a.getName()));
		resultList.add(new BdStringHelperReplacementPattern("書名", a.getJavadocTitle()));
		return resultList;
	}
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserServiceMethodParameter p){
		List<BdStringHelperReplacementPattern> resultList = new ArrayList<BdStringHelperReplacementPattern>();
		resultList.add(new BdStringHelperReplacementPattern("name", p.getName()));
		resultList.add(new BdStringHelperReplacementPattern("書名", p.getTitle()));
		return resultList;
	}
