...
import jp.co.nextdesign.ddb.core.template.cases.BdCodeCaseHtmlDomainClassListPageEntityAll;
import jp.co.nextdesign.util.logging.NdLogger;

public class BdCodeBlockHtmlDomainClassListPageEntity extends BdCodeBlockBaseDomainClassListPageEntity {

	/** コンストラクタ */
	public BdCodeBlockHtmlDomainClassListPageEntity(List<BdCodeLine> lineList){
		super(lineList);
	}
	...
	protected BdBaseCodeCase createCodeCase(String key, List<BdCodeLine> lineListOfCase){
		...
		if (BdBaseCodeCase.KEY_All.equals(key)){
			result = new BdCodeCaseHtmlDomainClassListPageEntityAll(lineListOfCase);
		} else {
