...
public class BdCodeFileOneToManySelectPanelHtml extends BdBaseCodeFile {
	 ...
	 */
	public BdCodeFileOneToManySelectPanelHtml(File file, BdTemplateProject project) throws BdBuilderException, BdApplicationPropertyException{
		super(file, project);
	}
