...
import jp.co.nextdesign.ddb.core.template.block.BdCodeBlockHtmlServiceResultPageNavi;
...
public class BdCodeFileServiceMethodResultPageHtml extends BdBaseCodeFile {
	 ...
	 */
	public BdCodeFileServiceMethodResultPageHtml(File file, BdTemplateProject project) throws BdBuilderException, BdApplicationPropertyException{
		super(file, project);
	}
	...
	protected BdBaseCodeBlock createCodeBlock(String key, List<BdCodeLine> lineListOfBlock){
		...
		if (BLOCK_KEY_Navi.equals(key)){
			result = new BdCodeBlockHtmlServiceResultPageNavi(lineListOfBlock);
		} else {
