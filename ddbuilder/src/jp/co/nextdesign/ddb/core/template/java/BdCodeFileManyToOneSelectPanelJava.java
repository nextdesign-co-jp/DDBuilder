...
public class BdCodeFileManyToOneSelectPanelJava extends BdBaseCodeFile {
	 ...
	 */
	public BdCodeFileManyToOneSelectPanelJava(File file, BdTemplateProject project) throws BdBuilderException, BdApplicationPropertyException{
		super(file, project);
	}
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserClass c, BdUserAttribute a){
		...
		resultList.add(new BdStringHelperReplacementPattern("Author", a.getNdAttributeType().getSimpleOrQualifiedName()));
		return resultList;
	}
