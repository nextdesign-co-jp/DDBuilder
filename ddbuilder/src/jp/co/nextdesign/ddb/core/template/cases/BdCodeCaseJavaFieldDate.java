...
public class BdCodeCaseJavaFieldDate extends BdBaseCodeCase {
	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseJavaFieldDate(List<BdCodeLine> lineListOfCase){
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserAttribute a){
		...
		resultList.add(new BdStringHelperReplacementPattern("datePicker", a.getName() + "DatePicker"));
		return resultList;
	}
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserServiceMethodParameter p){
		...
		resultList.add(new BdStringHelperReplacementPattern("paramPublishedAt", p.getName()));
		resultList.add(new BdStringHelperReplacementPattern("publishedAt", p.getName()));
		resultList.add(new BdStringHelperReplacementPattern("datePicker", p.getName() + "DatePicker"));
		return resultList;
	}
