...
public class BdCodeCaseJavaServiceResultPageNaviOneToMany extends BdBaseCodeCase {
	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseJavaServiceResultPageNaviOneToMany(List<BdCodeLine> lineListOfCase){
