...
public class BdCodeCaseJavaImportDate extends BdBaseCodeCase {

	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseJavaImportDate(List<BdCodeLine> lineListOfCase){
	...
	public List<String> generate(BdUserClass c){
		...
		for(String line : c.getImportList()){
			if (line != null && line.endsWith(".Date")){
