...
public class BdCodeCaseJavaFieldString extends BdBaseCodeCase {

	/**
	 * コンストラクタ
	 * @param lineListOfCase
	 */
	public BdCodeCaseJavaFieldString(List<BdCodeLine> lineListOfCase){
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserServiceMethodParameter p){
		...
		resultList.add(new BdStringHelperReplacementPattern("paramName", p.getName()));
