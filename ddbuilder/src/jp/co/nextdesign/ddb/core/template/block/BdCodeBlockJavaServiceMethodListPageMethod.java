...
import jp.co.nextdesign.ddb.core.template.cases.BdCodeCaseJavaServiceMethodListPageMethodAll;
import jp.co.nextdesign.util.logging.NdLogger;

public class BdCodeBlockJavaServiceMethodListPageMethod extends BdCodeBlockBaseServiceMethodListPageMethod {

	/** コンストラクタ */
	public BdCodeBlockJavaServiceMethodListPageMethod(List<BdCodeLine> lineList){
		super(lineList);
	}
	...
	protected BdBaseCodeCase createCodeCase(String key, List<BdCodeLine> lineListOfCase){
		...
		if (BdBaseCodeCase.KEY_All.equals(key)){
			result = new BdCodeCaseJavaServiceMethodListPageMethodAll(lineListOfCase);
		} else {
