 ...
 *
 */
public class BdCodeFileMultipleSelectPanelJava extends BdBaseCodeFile {
	 ...
	 */
	public BdCodeFileMultipleSelectPanelJava(File file, BdTemplateProject project) throws BdBuilderException, BdApplicationPropertyException{
		super(file, project);
	}
	...
	private List<BdStringHelperReplacementPattern> createReplacementPatternList(BdUserServiceMethod m, BdUserServiceMethodParameter p){
		...
		if (bdUserClass != null){
			resultList.add(new BdStringHelperReplacementPattern("edtion", bdUserClass.getLowerStartedName()));
